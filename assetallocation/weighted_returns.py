...
def weighted_returns(start_year, end_year, input_price, stock_symbols, weights, time_period):
    ...
    # finding returns of portfolio_prices
    portfolio_returns_dataframe = portfolio_prices.pct_change(1)

    # changing the nan to 0
    portfolio_returns_dataframe = portfolio_returns_dataframe.fillna(0)
